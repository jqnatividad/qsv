...
* **[explode](/src/cmd/explode.rs#L8)** - Explode rows into multiple ones by splitting a column value based on the
given separator. _**(NEW)**_
...
* **[flatten](/src/cmd/flatten.rs#L12)** - A flattened view of CSV records. Useful for viewing one record
...
* **[index](/src/cmd/index.rs#L13)** - Create an index for a CSV file. This is very quick and provides
...
* **[search](/src/cmd/search.rs#L10)** - Run a regex over CSV data. Applies the regex to each field
...
* **[slice](/src/cmd/slice.rs#L11)** - Slice rows from any part of a CSV file. When an index is present,
...
* **[stats](/src/cmd/stats.rs#L23)** - Show basic types and statistics of each column in the CSV file.
  (i.e., mean, standard deviation, variance, median, min/max, nullcount, etc.) _**(EXTENDED)**_
* **[table](/src/cmd/table.rs#L12)** - Show aligned output of any CSV data using
