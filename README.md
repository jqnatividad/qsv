...
| `QSV_PROGRESSBAR` | if set, enable the --progressbar option on the `apply`, `fetch`, `fetchpost`, `foreach`, `lua`, `py`, `search`, `searchset`, `sortcheck` and `validate` commands.  |
