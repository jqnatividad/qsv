...
| [extsort](/src/cmd/extsort.rs#L11)[^5] | Sort an arbitrarily large CSV/text file using an [external merge sort](https://en.wikipedia.org/wiki/External_sorting) algorithm. |
