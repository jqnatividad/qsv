...
[Luau 0.594](https://github.com/Roblox/luau/releases/tag/0.594) is currently embedded - qsv's policy is to use the latest stable Luau version at the time of each qsv release.
...
## Testing
qsv has ~1,190 tests in the [tests](https://github.com/jqnatividad/qsv/tree/master/tests) directory.
