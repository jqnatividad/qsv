...
[![Minimum supported Rust version](https://img.shields.io/badge/Rust-1.71.0-red?logo=rust)](#minimum-supported-rust-version)
...
[Luau 0.583](https://github.com/Roblox/luau/releases/tag/0.583) is currently embedded - qsv's policy is to use the latest stable Luau version at the time of each qsv release.
