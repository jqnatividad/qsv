...
🐻‍❄️: command powered by [![polars 0.43.1 at the py-1.9.0 tag](https://img.shields.io/badge/polars-0.43.1-blue) at py-1.9.0 tag](https://github.com/pola-rs/polars/releases/tag/py-1.9.0).  
