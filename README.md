...
[![Minimum supported Rust version](https://img.shields.io/badge/Rust-1.79-red?logo=rust)](#minimum-supported-rust-version)
...
| [clipboard](/src/cmd/clipboard.rs#L2) | Provide input from clipboard or save output to clipboard. |
...
🐻‍❄️: command powered by [![polars 0.41.3](https://img.shields.io/badge/polars-0.41.3-blue)](https://github.com/pola-rs/polars/releases/tag/rs-0.41.3) engine.  
...
## Testing
qsv has ~1,520 tests in the [tests](https://github.com/jqnatividad/qsv/tree/master/tests) directory.
