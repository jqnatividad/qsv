...
retrieve record count, sort breaks & duplicate count. |
...
[Luau 0.577](https://github.com/Roblox/luau/releases/tag/0.577) is currently embedded - qsv's policy is to use the latest stable Luau version at the time of each qsv release.
