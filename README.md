...
| [luau](/src/cmd/luau.rs#L2)<br>❇️📇 | Create multiple new computed columns, filter rows or compute aggregations by executing a [Luau](https://luau-lang.org) [0.567](https://github.com/Roblox/luau/releases/tag/0.567) expression/script for every row of a CSV file ([sequential mode](https://github.com/jqnatividad/qsv/blob/444ef8d380567fded26911ea41a28a7b1d5a17ff/tests/test_luau.rs#L254-L277)), or using [random access](https://www.webopedia.com/definitions/random-access/) with an index ([random access mode](https://github.com/jqnatividad/qsv/blob/444ef8d380567fded26911ea41a28a7b1d5a17ff/tests/test_luau.rs#L523-L573)). Can process a single Luau expression or full-fledged data-wrangling scripts with discrete BEGIN, MAIN and END sections. |
