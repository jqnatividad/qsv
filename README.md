...
🐻‍❄️: command powered by [![polars 0.39.1](https://img.shields.io/badge/polars-0.39.1-blue)](https://github.com/pola-rs/polars/releases/tag/rs-0.39.1) engine.  
...
## Testing
qsv has ~1,350 tests in the [tests](https://github.com/jqnatividad/qsv/tree/master/tests) directory.
