...
🐻‍❄️: command powered by [![polars 0.41.2 at py-1.0.0 tag](https://img.shields.io/badge/polars-0.41.2_(py_1.0.0_tag)-blue)](https://github.com/pola-rs/polars/releases/tag/py-1.0.0) engine.  
