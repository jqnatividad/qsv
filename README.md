...
| `QSV_USER_AGENT`| the user-agent to use for web requests. When specifying a custom user agent, try to conform to the [IETF RFC 72321 standard](https://tools.ietf.org/html/rfc7231#section-5.5.3). See [here](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/User-Agent) for examples.<br>(default: QSV_BINARY_VARIANT/QSV_VERSION (TARGET-TRIPLE; https://github.com/jqnatividad/qsv) - e.g.<br>`qsv/0.99.1 (x86_64-unknown-linux; https://github.com/jqnatividad/qsv)`).|
