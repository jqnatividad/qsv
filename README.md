...
[![Minimum supported Rust version](https://img.shields.io/badge/Rust-1.70.0-red?logo=rust)](#minimum-supported-rust-version)
...
| [sqlp](/src/cmd/sqlp.rs#L2)<br>✨🚀🐻‍❄️ | Run blazing-fast Polars SQL queries against several CSVs - converting queries to [fast LazyFrame expressions](https://towardsdatascience.com/understanding-lazy-evaluation-in-polars-b85ccb864d0c), processing larger than memory CSV files. |
...
[Luau 0.579](https://github.com/Roblox/luau/releases/tag/0.579) is currently embedded - qsv's policy is to use the latest stable Luau version at the time of each qsv release.
