 ...
 * all enabled features (`apply`, `fetch`, `foreach`, `generate`, `luau`, `luajit`, `python` & `self_update`)
...
* compiled with the last known Rust nightly/unstable that can build qsv (presently nightly-2022-11-19).
...
```
rustup default nightly-2022-11-19
rustup update
