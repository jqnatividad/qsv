...
# `cargo build --release --locked -F feature_capable,apply,geocode,luau,polars`; 
# `cargo install --locked qsv -F feature_capable,apply,geocode,luau,polars`; or 
# `cargo install --locked --path . -F feature_capable,apply,geocode,luau,polars` 
