{% set cb_result = register_lookup("cb_lookup","dathere://NYC_communityboards.csv") %}
...
{% if Community_Board %}Community Board: {{Community_Board}}-{{Community_Board|lookup("cb_lookup", "neighborhoods")}}{% endif %}
