...
https://github.com/pola-rs/polars/blob/py-1.8.2/crates/polars-sql/src/functions.rs and
https://github.com/pola-rs/polars/blob/py-1.8.2/crates/polars-sql/src/keywords.rs.
