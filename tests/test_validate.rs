...
2014-07-07 00:00,http://opendatacommunities.org/id/district-council/adur,Adur,http://id.esd.org.uk/service/579,Public toilets,PUBLIC CONVENIENCES SHOPSDAM ROAD LANCING,OSGB36,518915,103795,http://www.ordnancesurvey.co.uk/business-and-government/help-and-support/public-sector/guidance/derived-data-exemptions.html,Female and male,Unisex,Yes,No,No,No,No,No,No,,,http://www.adur-worthing.gov.uk/streets-and-travel/public-toilets/,"S = 09:00 - 21:00 W = 09:00 - 17:00",ADC,surveyors@adur-worthing.gov.uk,01903 221471,,60007428,,PUBLIC CONVENIENCES SHOPSDAM ROAD LANCING,,
...
"#;
    ...
    // row 3: wrong date format for ExtractDate
...
{"valid":false,"errors":[{"keywordLocation":"/properties/ExtractDate/pattern","instanceLocation":"/ExtractDate","absoluteKeywordLocation":"https://example.com/properties/ExtractDate/pattern","error":"\"2014-07-07 00:00\" does not match \"\\d{2}\\/\\d{2}\\/\\d{4} 00:00\""}],"row_index":3}
"#;
    ...
    let validation_error_output: String = wrk.from_str(&wrk.path("data.csv.validation-errors.jsonl"));
    assert_eq!(validation_errors_expected.to_string(), validation_error_output);
